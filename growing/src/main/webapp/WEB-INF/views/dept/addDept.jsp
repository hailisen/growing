...
<head>
    ...
    <div id="add-dept">
        <div id="title">
            <label id="title-text">新增部门</label>
            <label class="exit jexit">×</label>
        </div>
        <div id="neirong">
            <form action="${pageContext.request.contextPath}/dept/add" id="add-from" method="post">
                <table id="add-table">
                    <tr>
                        <td class="left-td">部门名称</td>
                        <td class="right-td">
                            <input class="input-text layui-input" type="text" name="deptName" id="deptName" value=""  placeholder="请输入名称">
                        </td>
                    </tr>
                    <tr>
                        <td class="left-td">部门描述</td>
                        <td class="right-td"><textarea placeholder="请输入描述" style="margin-left: 36px; margin-top: 6px;" id="dept-note" class="layui-textarea" name="note"></textarea></td>
                    </tr>
                    <tr >
