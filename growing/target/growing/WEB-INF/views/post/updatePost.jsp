...
<div id="add-dept">
    <div id="title">
        <label id="title-text">修改岗位</label>
        <label class="exit jexit">×</label>
    </div>
    <div id="neirong">
        <form action="${pageContext.request.contextPath}/post/update" id="add-from" method="post">
            <table id="add-table">
                <tr>
                    <td class="left-td">岗位名称</td>
                    <td class="right-td">
                        <input class="input-text layui-input" type="text" name="postName" id="postName" value="${post.postName}"  placeholder="请输入名称">
                ...
                <tr>
                    ...
                    <td class="right-td">
                        <textarea placeholder="请输入描述" style="margin-left: 36px; margin-top: 6px;" id="post-note" class="layui-textarea" name="note">${post.note}
                        </textarea>
                    </td>
                </tr>
                <tr >
